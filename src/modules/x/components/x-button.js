...
class XButton extends HTMLElement  {
    ...
    _raisePageCommandEvent() {
        this.dispatchEvent(new CustomEvent("page:command", {detail: {command: this._command, data: this.dataset}, bubbles: true, composed: false}));
    }
